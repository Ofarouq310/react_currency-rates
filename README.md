...
# 📖 Currency rates <a name="about-project"></a>

- Currency rates is an application that gives the user the chance to track all currencies' rates around the world, with the USD as a base currency using daily updated API data.
...
- [Currency Rates](https://ofq310-currency-rates.vercel.app/)
